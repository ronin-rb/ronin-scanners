...
module Ronin
  module Scanners
    ...
    class NiktoTask < RProgram::Task
      ...
      short_option :flag => '-output'
      short_option :flag => '-port'
      short_option :flag => '-root'
      short_option :flag => '-ssl'
      short_option :flag => '-timeout'
      short_option :flag => '-useproxy', :name => :enable_proxy
      short_option :flag => '-vhost'
      short_option :flag => '-Version', :name => :version

      short_option :flag => '-dbcheck', :name => :validate_checks
      short_option :flag => '-debug'
      short_option :flag => '-update'
      short_option :flag => '-verbose'
